...
# edit               | Opens any file in Sublime Text editor
...
#   -------------------------------
#   0. PRE-EXISTING SETTINGS
#   -------------------------------

#  Description:  These settings were present here before I added the additional settings below
...
PATH="/usr/local/bin:/Library/Frameworks/Python.framework/Versions/3.5/bin:/Applications/Postgres.app/Contents/Versions/latest/bin:${PATH}"
export PATH

#  ---------------------------------------------------------------------------
#
#  Description:  This file holds all my BASH configurations and aliases
#  Source:       Nathaniel Landau | https://natelandau.com/my-mac-osx-bash_profile/

#
#  Sections:
# -1.  Michael Additions
#  0.  Existing (Was here before changes were made)
...
#   Section contains code (or references to code) that represent my custom additions to this profile

#   1. Added git repo to path (see parse_git_branch() and PS1 var in section 1 Environemnt Config)
#   2. Added -1.2 displayplacer shortcuts for changing monitor resolution

#   -1.2 displayplacer shortcuts

    alias dp-small="displayplacer 'id:6BE19EEB-A027-0135-289F-617ADCFEBA7C mode:0'"
    alias dp-norm="displayplacer 'id:6BE19EEB-A027-0135-289F-617ADCFEBA7C mode:1'"
    alias dp-large="displayplacer 'id:6BE19EEB-A027-0135-289F-617ADCFEBA7C mode:18'"
...
#   per https://www.mfitzp.com/tutorials/add-git-branch-name-to-terminal-prompt-mac/
#   color per https://gist.github.com/vratiu/9780109
parse_git_branch() {
...
alias ll='ls -FGAShp'                        # Preferred 'ls' implementation
